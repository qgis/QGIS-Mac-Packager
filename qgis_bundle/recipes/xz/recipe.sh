...
function postbundle_xz() {
    ...
    install_name_change /opt/QGIS/qgis-deps-0.3.0/stage/lib/liblzma.5.dylib @rpath/liblzma.5.dylib $BUNDLE_CONTENTS_DIR/Resources/python/lib-dynload/_lzma.cpython-37m-darwin.so
}
