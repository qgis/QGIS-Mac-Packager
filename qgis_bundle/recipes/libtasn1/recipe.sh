...
function postbundle_libtasn1() {
 ...
 install_name_change $DEPS_LIB_DIR/$LINK_libtasn1 @rpath/$LINK_libtasn1 $BUNDLE_CONTENTS_DIR/PlugIns/qgis/libevis.so
 ...
 install_name_change $DEPS_LIB_DIR/$LINK_libtasn1 @rpath/$LINK_libtasn1 $BUNDLE_CONTENTS_DIR/PlugIns/qgis/libcoordinatecaptureplugin.so
 ...
 install_name_change $DEPS_LIB_DIR/$LINK_libtasn1 @rpath/$LINK_libtasn1 $BUNDLE_CONTENTS_DIR/PlugIns/qgis/libgeorefplugin.so
