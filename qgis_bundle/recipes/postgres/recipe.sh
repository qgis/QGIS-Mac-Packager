...
function postbundle_postgres() {
 ...
 install_name_change $DEPS_LIB_DIR/libpq.5.dylib @rpath/libpq.5.dylib $BUNDLE_CONTENTS_DIR/Resources/python/site-packages/psycopg2/_psycopg.cpython-37m-darwin.so
}
