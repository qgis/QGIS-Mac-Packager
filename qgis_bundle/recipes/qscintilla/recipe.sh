...
function postbundle_qscintilla() {
 ...
 install_name_change $DEPS_LIB_DIR/$LINK_libqscintilla2_qt5 @rpath/$LINK_libqscintilla2_qt5 $BUNDLE_CONTENTS_DIR/PlugIns/qgis/libevis.so
 ...
 install_name_change $DEPS_LIB_DIR/$LINK_libqscintilla2_qt5 @rpath/$LINK_libqscintilla2_qt5 $BUNDLE_CONTENTS_DIR/PlugIns/qgis/libcoordinatecaptureplugin.so
 ...
 install_name_change $DEPS_LIB_DIR/$LINK_libqscintilla2_qt5 @rpath/$LINK_libqscintilla2_qt5 $BUNDLE_CONTENTS_DIR/PlugIns/qgis/libgeorefplugin.so
 ...
 install_name_change $DEPS_LIB_DIR/libqscintilla2_qt5.15.dylib @rpath/libqscintilla2_qt5.15.dylib $BUNDLE_CONTENTS_DIR/Resources/python/site-packages/PyQt5/Qsci.so
}
