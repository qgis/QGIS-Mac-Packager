...
function postbundle_protobuf() {
 ...
 install_name_change $DEPS_LIB_DIR/$LINK_protobuf_lite @rpath/$LINK_protobuf_lite $BUNDLE_CONTENTS_DIR/PlugIns/qgis/libevis.so
 ...
 install_name_change $DEPS_LIB_DIR/$LINK_protobuf_lite @rpath/$LINK_protobuf_lite $BUNDLE_CONTENTS_DIR/PlugIns/qgis/libcoordinatecaptureplugin.so
 ...
 install_name_change $DEPS_LIB_DIR/$LINK_protobuf_lite @rpath/$LINK_protobuf_lite $BUNDLE_CONTENTS_DIR/PlugIns/qgis/libgeorefplugin.so
