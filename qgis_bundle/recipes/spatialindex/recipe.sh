...
function postbundle_spatialindex() {
 install_name_id @rpath/libspatialindex_c.6.dylib $BUNDLE_CONTENTS_DIR/MacOS/lib/libspatialindex_c.6.1.1.dylib
 ...
 install_name_change $DEPS_LIB_DIR/$LINK_spatialindex @rpath/$LINK_spatialindex $BUNDLE_CONTENTS_DIR/PlugIns/qgis/libevis.so
