...
function fix_binaries_qtwebkit() {
  ...
  install_name_delete_rpath $QGIS_DEPS_PATH/build/qtwebkit/build-x86_64/lib $BUNDLE_CONTENTS_DIR/Frameworks/QtWebKitWidgets.framework/Versions/5/QtWebKitWidgets
