...
function postbundle_libzip() {
 ...
 install_name_change $DEPS_LIB_DIR/$LINK_libzip @rpath/$LINK_libzip $BUNDLE_CONTENTS_DIR/PlugIns/qgis/libevis.so
 ...
 install_name_change $DEPS_LIB_DIR/$LINK_libzip @rpath/$LINK_libzip $BUNDLE_CONTENTS_DIR/PlugIns/qgis/libcoordinatecaptureplugin.so
 ...
 install_name_change $DEPS_LIB_DIR/$LINK_libzip @rpath/$LINK_libzip $BUNDLE_CONTENTS_DIR/PlugIns/qgis/libgeorefplugin.so
