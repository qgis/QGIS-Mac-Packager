...
function postbundle_gdal() {
 ...
 install_name_change /opt/QGIS/qgis-deps-0.3.0/stage/lib/libgdal.26.dylib @rpath/libgdal.26.dylib $BUNDLE_CONTENTS_DIR/MacOS/lib/libgrass_vector.7.8.dylib
 ...
 install_name_change /opt/QGIS/qgis-deps-0.3.0/stage/lib/libgdal.26.dylib @rpath/libgdal.26.dylib $BUNDLE_CONTENTS_DIR/Resources/python/site-packages/GDAL-3.0.4-py3.7-macosx-10.13.0-x86_64.egg/osgeo/_osr.cpython-37m-darwin.so
 install_name_change /opt/QGIS/qgis-deps-0.3.0/stage/lib/libgdal.26.dylib @rpath/libgdal.26.dylib $BUNDLE_CONTENTS_DIR/Resources/python/site-packages/GDAL-3.0.4-py3.7-macosx-10.13.0-x86_64.egg/osgeo/_gdal_array.cpython-37m-darwin.so
 install_name_change /opt/QGIS/qgis-deps-0.3.0/stage/lib/libgdal.26.dylib @rpath/libgdal.26.dylib $BUNDLE_CONTENTS_DIR/Resources/python/site-packages/GDAL-3.0.4-py3.7-macosx-10.13.0-x86_64.egg/osgeo/_gdal.cpython-37m-darwin.so
 install_name_change /opt/QGIS/qgis-deps-0.3.0/stage/lib/libgdal.26.dylib @rpath/libgdal.26.dylib $BUNDLE_CONTENTS_DIR/Resources/python/site-packages/GDAL-3.0.4-py3.7-macosx-10.13.0-x86_64.egg/osgeo/_ogr.cpython-37m-darwin.so
 install_name_change /opt/QGIS/qgis-deps-0.3.0/stage/lib/libgdal.26.dylib @rpath/libgdal.26.dylib $BUNDLE_CONTENTS_DIR/Resources/python/site-packages/GDAL-3.0.4-py3.7-macosx-10.13.0-x86_64.egg/osgeo/_gnm.cpython-37m-darwin.so
 install_name_change /opt/QGIS/qgis-deps-0.3.0/stage/lib/libgdal.26.dylib @rpath/libgdal.26.dylib $BUNDLE_CONTENTS_DIR/Resources/python/site-packages/GDAL-3.0.4-py3.7-macosx-10.13.0-x86_64.egg/osgeo/_gdalconst.cpython-37m-darwin.so
}
